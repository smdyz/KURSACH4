...
# get = GetVacancy("Frontend")
#
# print(get.get_vacancies)

# print(json.dumps(get.get_vacancies(), indent=2, ensure_ascii=False))
# get.save_info()

# vac = SalaryVacancy("Сантехник")
# q = vac.sorted_salary(10)
# print(q)

# key = KeyVacancy("верстка")
# print(json.dumps(key.get_vacancies, indent=2, ensure_ascii=False))
